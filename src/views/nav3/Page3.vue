<template>
	<section>
		...
		<!--列表-->
		<el-table :data="maintains" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="cStartTime" label="创建开始时间" width="150" center sortable>
			</el-table-column>
			<el-table-column prop="cEndTime" label="创建截止时间" width="150" center sortable>
			</el-table-column>
			<el-table-column prop="uStartTime" label="更新开始时间" width="150" center sortable>
			</el-table-column>
			<el-table-column prop="uEndTime" label="更新截止时间" width="150" center sortable>
			</el-table-column>
